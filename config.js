...
const CONFIG = {
  ...
  accounts: {
    groom: [
      { role: "신랑", name: "서은덕 ", bank: "토스뱅크", number: "1002-4112-5088" },
      { role: "아버지", name: "서동현", bank: "농협은행", number: "463144-52-077963" },
      { role: "어머니", name: "김혜숙", bank: "농협은행", number: "463142-52-346561" }
    ],
    bride: [
      { role: "신부", name: "정세은", bank: "하나은행", number: "516-910210-88107" },
      { role: "아버지", name: "정재복", bank: "농협은행", number: "798-12-253904" },
      { role: "어머니", name: "김지영", bank: "대구은행", number: "242-13-068473" }
    ]
  },
